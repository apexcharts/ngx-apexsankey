...
@Component({
  selector: 'app-custom-fonts-demo',
  standalone: true,
    ...
    <div class="demo-page">
      <div class="container">
        ...
        <div class="demo-header">
          <h1>Custom Fonts</h1>
          <p>Using custom Google Fonts with a job application flow diagram</p>
        </div>
...
export class CustomFontsDemoComponent {
  data: GraphData = {
    nodes: [
...
// don't forget to include the font in your index.html:
